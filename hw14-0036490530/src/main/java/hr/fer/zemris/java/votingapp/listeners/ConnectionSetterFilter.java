...
import hr.fer.zemris.java.votingapp.dao.sql.SQLConnectionProvider;

/**
 * Filters all request for servlets by creating a new connection using a connection pool
